...
| 0.3 | Write docker-compose.yml (TimescaleDB, Redis, Kafka, MLflow, Grafana, Prometheus) | ✅ | infrastructure/docker/docker-compose.yml |
| 0.4 | Create requirements.txt | ✅ | |
| 0.5 | Create requirements-dev.txt | ✅ | |
...
| 0.9 | TimescaleDB schema + migrations | ✅ | infrastructure/database/timescaledb/schema.sql |
| 0.10 | MLflow tracking server configured | ✅ | Part of Docker stack |
| 0.11 | Grafana + Prometheus stack running | ✅ | Dashboards in monitoring/dashboards/ |
| 0.12 | Kafka 3-broker local cluster | ✅ | Part of Docker stack |
...
| 0.17 | Unit tests for all base classes | ✅ | tests/unit/ |
| 0.18 | Logging infrastructure (structlog or loguru) | ✅ | |
...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 1.1 | scripts/download_data.py — Dukascopy tick downloader | ✅ | Oanda/yfinance downloader |
| 1.2 | Download 5yr tick data — EUR/USD | ✅ | data/EUR_USD_ticks.csv |
| 1.3 | Download 5yr tick data — GBP/USD, USD/JPY, USD/CHF | ⬜ | |
| 1.4 | Download 5yr tick data — EUR/GBP, EUR/JPY, AUD/USD, NZD/USD | ⬜ | |
| 1.5 | OHLCV resampler (tick → 1m/5m/1h/4h/1d) | ✅ | backtesting/data_handler.py |
| 1.6 | Data quality validator (gap detection, outlier flagging) | ⬜ | |
| 1.7 | Load all historical data into TimescaleDB | 🔄 | In progress (in plan) |
| 1.8 | Verify data completeness (% gaps per pair) | ⬜ | |

### Live Data Streaming
| # | Task | Status | Notes |
|---|------|--------|-------|
| 1.9 | OANDA streaming WebSocket adapter | ✅ | execution/brokers/oanda_broker.py |
| 1.10 | Kafka producer for live tick stream | ✅ | infrastructure/trading_pipeline.py |
| 1.11 | Redis tick cache (latest 1000 ticks per pair) | ✅ | infrastructure/database/redis/ |
| 1.12 | Order book streaming + storage | ✅ | execution/brokers/oanda_broker.py |
| 1.13 | Integration test: stream 48hr without errors | ⬜ | |
| 1.14 | Data freshness monitoring alert | ✅ | monitoring/signal_monitor.py |

### Alternative Data
| # | Task | Status | Notes |
|---|------|--------|-------|
| 1.15 | Economic calendar pipeline (ForexFactory or Investing.com) | ✅ | features/alternative/macro_surprise.py |
| 1.16 | COT report parser (CFTC weekly data) | ✅ | features/alternative/cot_positioning.py |
| 1.17 | News NLP pipeline (FinBERT sentiment scoring) | ✅ | features/alternative/sentiment.py |
| 1.18 | Kafka topics for all data streams | ✅ | configs/loader.py |
...
| 2.4 | features/microstructure/vpin.py | ✅ | |
| 2.5 | features/microstructure/kyle_lambda.py | ✅ | |
| 2.6 | features/microstructure/amihud.py | ✅ | |
| 2.7 | Unit tests: all microstructure features | ✅ | tests/unit/ |
...
| 2.10 | features/technical/mean_reversion.py | ✅ | |
| 2.11 | features/technical/trend.py | ✅ | |
| 2.12 | features/technical/volume.py | ✅ | |
| 2.13 | Unit tests: all technical features | ✅ | tests/unit/ |
...
| 2.17 | Unit tests: wavelet features | ✅ | tests/unit/ |
...
| 3.4 | models/temporal/trainer.py | ✅ | |
| 3.5 | Hyperparameter search (Ray Tune) | ⬜ | |
| 3.6 | Evaluate: IC, ICIR, signal decay | ✅ | scripts/train_temporal.py |
...
| 3.16 | models/rl_agent/reward_functions.py | ✅ | |
| 3.17 | models/rl_agent/ppo_agent.py | ✅ | |
| 3.18 | models/rl_agent/sac_agent.py | ✅ | |
| 3.19 | models/rl_agent/trainer.py | ✅ | |
...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 3.25 | models/meta_learner/maml.py | ✅ | |
...
| 3.32 | models/ensemble/signal_generator.py | ✅ | |
...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 4.1 | risk/sizing/kelly.py | ✅ | |
| 4.2 | risk/sizing/volatility_scaled.py | ✅ | |
| 4.3 | risk/limits/cvar_limits.py | ✅ | |
| 4.4 | risk/limits/drawdown_limits.py | ✅ | |
...
| 4.12 | Unit tests: all circuit breakers | ✅ | tests/unit/ |
| 4.13 | Integration test: risk engine gates bad orders | ✅ | tests/integration/ |
...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 6.1 | backtesting/engines/event_driven.py | ✅ | |
| 6.2 | backtesting/engines/vectorized.py | ✅ | |
| 6.3 | backtesting/performance.py | ✅ | |
...
| 6.7 | backtesting/scenarios/historical_stress.py | ✅ | |
...
| 7.10 | 30-day paper trading run | ⬜ | |
| 7.11 | Live deployment checklist complete | ⬜ | |
...
| D.4 | docs/api/API_REFERENCE.md | ✅ | |
| D.5 | docs/research/RESEARCH_NOTES.md | ✅ | |
